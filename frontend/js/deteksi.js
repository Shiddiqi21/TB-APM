...
const wasteData = {
  plastik:{
    ...
    refs:[
      {label: 'Botol plastik PET', img: 'images/plastik_1.jpg'},
      {label: 'Kantong kresek', img: 'images/plastik_2.jpg'},
      {label: 'Kemasan makanan', img: 'images/plastik_3.jpg'}
    ]
  },
  kaca:{
    ...
    refs:[
      {label: 'Botol kaca bening', img: 'images/kaca_1.jpg'},
      {label: 'Botol kaca berwarna', img: 'images/kaca_2.jpg'},
      {label: 'Toples kaca', img: 'images/kaca_3.jpg'}
    ]
  },
  logam:{
    ...
    refs:[
      {label: 'Kaleng aluminium', img: 'images/logam_1.jpg'},
      {label: 'Kaleng besi', img: 'images/logam_2.jpg'},
      {label: 'Besi tua', img: 'images/logam_3.jpg'}
    ]
  },
  kardus:{
    ...
    refs:[
      {label: 'Kardus bekas', img: 'images/kardus_1.jpg'},
      {label: 'Kotak karton', img: 'images/kardus_2.jpg'},
      {label: 'Kertas tebal', img: 'images/kardus_3.jpg'}
    ]
  }
};
...
function showResult(category, confidence, allPredictions){
  ...
  // Reference images (placeholders or real images)
  const refGrid = document.getElementById('refImagesGrid');
  refGrid.innerHTML = data.refs.map(ref => {
    const isObj = typeof ref === 'object';
    const label = isObj ? ref.label : ref;
    const img = isObj ? ref.img : null;
    
    if (img) {
      return `
        <div class="ref-img-card" style="background-image: url('${img}'); background-size: cover; background-position: center; border:none; overflow:hidden; border-radius:inherit;">
        </div>
      `;
    } else {
      return `
